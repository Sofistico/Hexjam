...
import hexdoc_hexjam

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexJamPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexJamModPlugin(branch=branch)


class HexJamModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexjam"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexjam, "_templates"
